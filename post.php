...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2 col-xs-12">
			...
			<img class="featured-image img-fluid" src="blog/img/demopic/10.jpg" alt="">
			<!-- End Featured Image -->
	...
	<div class="container">
		<div class="row listrecent listrelated">
			...
			<div class="col-md-4">
				<div class="card">
					<a href="post.html">
					<img class="img-fluid img-thumb" src="blog/img/demopic/9.jpg" alt="">
					</a>
			...
			<div class="col-md-4">
				<div class="card">
					<a href="post.html">
					<img class="img-fluid img-thumb" src="blog/img/demopic/8.jpg" alt="">
					</a>
					<div class="card-block">
			...
			<div class="col-md-4">
				<div class="card">
					<a href="post.html">
					<img class="img-fluid img-thumb" src="blog/img/demopic/7.jpg" alt="">
					</a>
					<div class="card-block">
